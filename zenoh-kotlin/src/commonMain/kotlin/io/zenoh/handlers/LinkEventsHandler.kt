...
/**
 * Handler interface for classes implementing behavior to handle incoming [LinkEvent] events.
 *
 * @param R An arbitrary receiver.
 */
@Unstable
interface LinkEventsHandler<R> {

    /**
     * Handle the received [LinkEvent].
     *
     * @param event A [LinkEvent].
     */
    fun handle(event: LinkEvent)
